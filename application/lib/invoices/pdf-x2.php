...
<body style="font-family:dejavusanscondensed">
    ...
    width: 10%;
    height: 120px;
    background: url('<?php echo APP_URL; ?>/application/storage/system/invoice_top_design.png') no-repeat center center;
...
">
    ...
    <div id="page-wrap">
            ...
            <table id="meta">
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="due"><?php echo ib_money_format($i_due, $config, $d['currency_symbol']); ?></div>
                        </td>
                    </tr>
        ...
        <table id="items">
            ...
            <tr>
                ...
                <td class="total-value">
                    <div id="subtotal"><?php echo ib_money_format($d['subtotal'], $config, $d['currency_symbol']); ?></div>
                </td>
            </tr>
            <?php
            if (($d['discount']) != '0.00') {
            ...
            ?>
                <tr>
                    ...
                    <td class="total-value">
                        <div id="subtotal"><?php echo ib_money_format($d['discount'], $config, $d['currency_symbol']); ?></div>
                    </td>
                </tr>
            <?php
            }
            ...
            ?>
                <tr>
                    ...
                    <td class="total-value">
                        <div id="total"><?php echo ib_money_format($d['tax'], $config, $d['currency_symbol']); ?></div>
                    </td>
                </tr>
            <?php
            }
            ...
            ?>
                <tr>
                    ...
                    <td class="total-value">
                        <div class="due"><?php echo ib_money_format($d['total'], $config, $d['currency_symbol']); ?></div>
                    </td>
                </tr>
                <tr>
                    <td class="blank"> </td>
                    ...
                    <td class="total-value">
                        <div class="due"><?php echo ib_money_format($d['credit'], $config, $d['currency_symbol']); ?></div>
                    </td>
                </tr>
                <tr>
                    <td class="blank"> </td>
        ...
        <?php if ($trs_c != '') { ?>
            ...
            <table id="related_transactions" style="width: 100%; border: none; border-collapse: collapse;">

                <tr>
                    <th style="background-color: #eee;border: none;" align="left" width="20%"><?php echo $_L['Date']; ?></th>
                    <th style="background-color: #eee;border: none;" align="left"><?php echo $_L['Account']; ?></th>
                    <th style="background-color: #eee;border: none;" width="50%" align="left"><?php echo $_L['Description']; ?></th>
                    <th style="background-color: #eee;border: none;" align="right"><?php echo $_L['Amount']; ?></th>
                ...
                foreach ($trs as $tr) {
                    echo '  <tr class="item-row">
                        <td align="left" style="border: none;">' . date($config['df'], strtotime($tr['date'])) . '</td>
                        <td align="left" style="border: none;">' . $tr['account'] . '</td>
                        <td align="left" style="border: none;">' . $tr['description'] . '</td>
                        <td align="right" style="border: none;"><span class="price">' . ib_money_format($tr['amount'], $config, $d['currency_symbol']) . '</span></td>
                    </tr>';
                }
                ?>
            </table>
